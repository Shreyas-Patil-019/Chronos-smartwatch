      ...
      {CATEGORIES.map((cat) => {
        ...
        return (
          <button
            ...
            className={`px-3.5 py-2 rounded-full text-xs font-mono uppercase tracking-wider whitespace-nowrap border transition-all duration-300 cursor-pointer select-none ${
