...
export const Button = ({
  ...
  if (variant === 'gold') {
    ...
    defaultStyles.background = 'linear-gradient(to right, #fde68a, #f59e0b)';
  ...
  return (
    ...
    >
      {isLoading ? (
        <span className="flex items-center gap-2" style={{ color: variant === 'gold' || variant === 'primary' ? '#000000' : 'inherit' }}>
