...
export const LifestyleSection = () => {
  ...
  // Guaranteed safe fallback matching activeMode
  ...
  return (
    <section id="lifestyle" className="relative py-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 border-t border-zinc-900">
      ...
      {/* Adaptive Mode Display Card — Fixed Solid Crossfade Transition */}
      <div className="relative min-h-[380px] sm:min-h-[340px] rounded-3xl border border-zinc-800 bg-zinc-950/80 overflow-hidden shadow-2xl">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className={`p-8 sm:p-12 bg-gradient-to-br ${currentMode.color} h-full flex flex-col justify-between`}
          >
            <div className="max-w-3xl space-y-6 relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                {currentMode.capabilities.map((cap, i) => (
                  <div key={i} className="px-3.5 py-2 rounded-xl bg-zinc-950/70 border border-zinc-800/80 text-[11px] font-mono text-zinc-300 flex items-center gap-2">
